<?php
//gen 25/2/2024 22:22:11 dst
class seg_tblparametrotipo_Ctrl
{
...
$Con = $oDav_Ctrol->fnDevuelveConsulta('seg_visparametrotipo' , $pCampo0  , $pValor0  , $pCampo1  , $pValor1  , $pCampo2  , $pValor2  , $pCampo3  , $pValor3  , $pCampo4  , $pValor4  , $pCampo5  , $pValor5  , $pCampo6  , $pValor6  , $pCampo7  , $pValor7 );
$sql = $Con;
try {
...
public function addparametrotipo($f3)
{
$idusuario = is_null($f3->get('POST.idusuario')) ? 'T' : $f3->get('POST.idusuario');
$llave = is_null($f3->get('POST.llave')) ? 'T' : $f3->get('POST.llave');
if ($this->M_Usuariologueado->ValidaSession($idusuario, $llave,'addparametrotipo',$f3)) {
$Tipo = 'C';
$idparametrotipo = is_null($f3->get('POST.pidparametrotipo')) ? 'T' : $f3->get('POST.pidparametrotipo');
...
$idparametrotipopadre = is_null($f3->get('POST.pidparametrotipopadre')) ? 'T' : $f3->get('POST.pidparametrotipopadre');
$sql = "CALL seg_pagparametrotipo('" . $Tipo . "','". $idparametrotipo . "','". $nombretabla . "','". $nombrecampo . "','". $valorcampo . "','". $descripcion . "','". $habilitado . "','". $idparametrotipopadre. "'); "; 
try {
$resulto = $f3->get('DB')->exec($sql);
$items = array();
$msg = '200';
...
public function getparametrotipo($f3)
{
$idusuario = is_null($f3->get('POST.idusuario')) ? 'T' : $f3->get('POST.idusuario');
$llave = is_null($f3->get('POST.llave')) ? 'T' : $f3->get('POST.llave');
if ($this->M_Usuariologueado->ValidaSession($idusuario, $llave,'getparametrotipo',$f3)) {
$Tipo = 'R';
$idparametrotipo = is_null($f3->get('POST.pidparametrotipo')) ? 'T' : $f3->get('POST.pidparametrotipo');
$nombretabla = is_null($f3->get('POST.pnombretabla')) ? 'T' : $f3->get('POST.pnombretabla');
$nombrecampo = is_null($f3->get('POST.pnombrecampo')) ? 'T' : $f3->get('POST.pnombrecampo');
...
public function updparametrotipo($f3)
{
$idusuario = is_null($f3->get('POST.idusuario')) ? 'T' : $f3->get('POST.idusuario');
$llave = is_null($f3->get('POST.llave')) ? 'T' : $f3->get('POST.llave');
if ($this->M_Usuariologueado->ValidaSession($idusuario, $llave,'updparametrotipo',$f3)) {
$Tipo = 'U';
$idparametrotipo = is_null($f3->get('POST.pidparametrotipo')) ? 'T' : $f3->get('POST.pidparametrotipo');
$nombretabla = is_null($f3->get('POST.pnombretabla')) ? 'T' : $f3->get('POST.pnombretabla');
$nombrecampo = is_null($f3->get('POST.pnombrecampo')) ? 'T' : $f3->get('POST.pnombrecampo');
...
public function papparametrotipo($f3)
{
$idusuario = is_null($f3->get('POST.idusuario')) ? 'T' : $f3->get('POST.idusuario');
$llave = is_null($f3->get('POST.llave')) ? 'T' : $f3->get('POST.llave');
if ($this->M_Usuariologueado->ValidaSession($idusuario, $llave,'papparametrotipo',$f3)) {
...
$habilitado = is_null($f3->get('POST.phabilitado')) ? 'T' : $f3->get('POST.phabilitado');
$idparametrotipopadre = is_null($f3->get('POST.pidparametrotipopadre')) ? 'T' : $f3->get('POST.pidparametrotipopadre');
$sql = "CALL " . $procedure . "('" . $Tipo . "','". $idparametrotipo . "','". $nombretabla . "','". $nombrecampo . "','". $valorcampo . "','". $descripcion . "','". $habilitado . "','". $idparametrotipopadre. "'); "; 
try {
$resulto = $f3->get('DB')->exec($sql);
$items = array();
$msg = '200';
