<?php
//gen 25/2/2024 22:22:09 dst
class seg_tbllogusuario_Ctrl
{
...
$Con = $oDav_Ctrol->fnDevuelveConsulta('seg_vislogusuario' , $pCampo0  , $pValor0  , $pCampo1  , $pValor1  , $pCampo2  , $pValor2  , $pCampo3  , $pValor3  , $pCampo4  , $pValor4  , $pCampo5  , $pValor5  , $pCampo6  , $pValor6  , $pCampo7  , $pValor7 );
$sql = $Con;
try {
...
public function addlogusuario($f3)
{
$idusuario = is_null($f3->get('POST.idusuario')) ? 'T' : $f3->get('POST.idusuario');
$llave = is_null($f3->get('POST.llave')) ? 'T' : $f3->get('POST.llave');
if ($this->M_Usuariologueado->ValidaSession($idusuario, $llave,'addlogusuario',$f3)) {
$Tipo = 'C';
$idlogusuario = is_null($f3->get('POST.pidlogusuario')) ? 'T' : $f3->get('POST.pidlogusuario');
$nombresistema = is_null($f3->get('POST.pnombresistema')) ? 'T' : $f3->get('POST.pnombresistema');
$idusuario = is_null($f3->get('POST.pidusuario')) ? 'T' : $f3->get('POST.pidusuario');
$nombreservicio = is_null($f3->get('POST.pnombreservicio')) ? 'T' : $f3->get('POST.pnombreservicio');
$sql = "CALL seg_paglogusuario('" . $Tipo . "','". $idlogusuario . "','". $nombresistema . "','". $idusuario . "','". $nombreservicio. "'); "; 
try {
$resulto = $f3->get('DB')->exec($sql);
$items = array();
$msg = '200';
...
public function getlogusuario($f3)
{
$idusuario = is_null($f3->get('POST.idusuario')) ? 'T' : $f3->get('POST.idusuario');
$llave = is_null($f3->get('POST.llave')) ? 'T' : $f3->get('POST.llave');
if ($this->M_Usuariologueado->ValidaSession($idusuario, $llave,'getlogusuario',$f3)) {
$Tipo = 'R';
$idlogusuario = is_null($f3->get('POST.pidlogusuario')) ? 'T' : $f3->get('POST.pidlogusuario');
$nombresistema = is_null($f3->get('POST.pnombresistema')) ? 'T' : $f3->get('POST.pnombresistema');
$idusuario = is_null($f3->get('POST.pidusuario')) ? 'T' : $f3->get('POST.pidusuario');
...
public function updlogusuario($f3)
{
$idusuario = is_null($f3->get('POST.idusuario')) ? 'T' : $f3->get('POST.idusuario');
$llave = is_null($f3->get('POST.llave')) ? 'T' : $f3->get('POST.llave');
if ($this->M_Usuariologueado->ValidaSession($idusuario, $llave,'updlogusuario',$f3)) {
$Tipo = 'U';
$idlogusuario = is_null($f3->get('POST.pidlogusuario')) ? 'T' : $f3->get('POST.pidlogusuario');
$nombresistema = is_null($f3->get('POST.pnombresistema')) ? 'T' : $f3->get('POST.pnombresistema');
$idusuario = is_null($f3->get('POST.pidusuario')) ? 'T' : $f3->get('POST.pidusuario');
...
public function paplogusuario($f3)
{
$idusuario = is_null($f3->get('POST.idusuario')) ? 'T' : $f3->get('POST.idusuario');
$llave = is_null($f3->get('POST.llave')) ? 'T' : $f3->get('POST.llave');
if ($this->M_Usuariologueado->ValidaSession($idusuario, $llave,'paplogusuario',$f3)) {
...
$idusuario = is_null($f3->get('POST.pidusuario')) ? 'T' : $f3->get('POST.pidusuario');
$nombreservicio = is_null($f3->get('POST.pnombreservicio')) ? 'T' : $f3->get('POST.pnombreservicio');
$sql = "CALL " . $procedure . "('" . $Tipo . "','". $idlogusuario . "','". $nombresistema . "','". $idusuario . "','". $nombreservicio. "'); "; 
try {
$resulto = $f3->get('DB')->exec($sql);
$items = array();
$msg = '200';
