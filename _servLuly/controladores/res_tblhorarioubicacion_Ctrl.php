<?php
//gen 28/11/2023 16:05:45 dst
class res_tblhorarioubicacion_Ctrl
{
...
public function selhorarioubicacion($f3)
{
$idusuario = is_null($f3->get('POST.idusuario')) ? 'T' : $f3->get('POST.idusuario');
$llave = is_null($f3->get('POST.llave')) ? 'T' : $f3->get('POST.llave');
if ($this->M_Usuariologueado->ValidaSession($idusuario, $llave,'selhorarioubicacion',$f3)) {
...
$Con = $oDav_Ctrol->fnDevuelveConsulta('res_vishorarioubicacion' , $pCampo0  , $pValor0  , $pCampo1  , $pValor1  , $pCampo2  , $pValor2  , $pCampo3  , $pValor3  , $pCampo4  , $pValor4  , $pCampo5  , $pValor5  , $pCampo6  , $pValor6  , $pCampo7  , $pValor7 );
$sql = $Con;
try {
...
public function addhorarioubicacion($f3)
{
$idusuario = is_null($f3->get('POST.idusuario')) ? 'T' : $f3->get('POST.idusuario');
$llave = is_null($f3->get('POST.llave')) ? 'T' : $f3->get('POST.llave');
if ($this->M_Usuariologueado->ValidaSession($idusuario, $llave,'addhorarioubicacion',$f3)) {
$Tipo = 'C';
$idhorarioubicacion = is_null($f3->get('POST.pidhorarioubicacion')) ? 'T' : $f3->get('POST.pidhorarioubicacion');
$idubicacion = is_null($f3->get('POST.pidubicacion')) ? 'T' : $f3->get('POST.pidubicacion');
$diaatencion = is_null($f3->get('POST.pdiaatencion')) ? 'T' : $f3->get('POST.pdiaatencion');
...
$sql = "CALL res_paghorarioubicacion('" . $Tipo . "','". $idhorarioubicacion . "','". $idubicacion . "','". $diaatencion . "','". $horareinicio . "','". $horarefin . "','". $horarefrigerioinicio . "','". $horarefrigeriofin . "','". $programarcita. "'); "; 
try {
$resulto = $f3->get('DB')->exec($sql);
$items = array();
$msg = '200';
...
public function gethorarioubicacion($f3)
{
$idusuario = is_null($f3->get('POST.idusuario')) ? 'T' : $f3->get('POST.idusuario');
$llave = is_null($f3->get('POST.llave')) ? 'T' : $f3->get('POST.llave');
if ($this->M_Usuariologueado->ValidaSession($idusuario, $llave,'gethorarioubicacion',$f3)) {
$Tipo = 'R';
$idhorarioubicacion = is_null($f3->get('POST.pidhorarioubicacion')) ? 'T' : $f3->get('POST.pidhorarioubicacion');
$idubicacion = is_null($f3->get('POST.pidubicacion')) ? 'T' : $f3->get('POST.pidubicacion');
$diaatencion = is_null($f3->get('POST.pdiaatencion')) ? 'T' : $f3->get('POST.pdiaatencion');
...
public function updhorarioubicacion($f3)
{
$idusuario = is_null($f3->get('POST.idusuario')) ? 'T' : $f3->get('POST.idusuario');
$llave = is_null($f3->get('POST.llave')) ? 'T' : $f3->get('POST.llave');
if ($this->M_Usuariologueado->ValidaSession($idusuario, $llave,'updhorarioubicacion',$f3)) {
$Tipo = 'U';
$idhorarioubicacion = is_null($f3->get('POST.pidhorarioubicacion')) ? 'T' : $f3->get('POST.pidhorarioubicacion');
$idubicacion = is_null($f3->get('POST.pidubicacion')) ? 'T' : $f3->get('POST.pidubicacion');
$diaatencion = is_null($f3->get('POST.pdiaatencion')) ? 'T' : $f3->get('POST.pdiaatencion');
...
public function res_paphorarioubicacion($f3)
{
$idusuario = is_null($f3->get('POST.idusuario')) ? 'T' : $f3->get('POST.idusuario');
$llave = is_null($f3->get('POST.llave')) ? 'T' : $f3->get('POST.llave');
if ($this->M_Usuariologueado->ValidaSession($idusuario, $llave,'paphorarioubicacion',$f3)) {
...
$horarefrigeriofin = is_null($f3->get('POST.phorarefrigeriofin')) ? 'T' : $f3->get('POST.phorarefrigeriofin');
$programarcita = is_null($f3->get('POST.pprogramarcita')) ? 'T' : $f3->get('POST.pprogramarcita');
$sql = "CALL " . $procedure . "('" . $Tipo . "','". $idhorarioubicacion . "','". $idubicacion . "','". $diaatencion . "','". $horareinicio . "','". $horarefin . "','". $horarefrigerioinicio . "','". $horarefrigeriofin . "','". $programarcita. "'); "; 
try {
$resulto = $f3->get('DB')->exec($sql);
$items = array();
$msg = '200';
