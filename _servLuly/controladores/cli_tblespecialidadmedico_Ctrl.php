<?php
//gen 25/2/2024 22:21:52 dst
class cli_tblespecialidadmedico_Ctrl
{
...
public function selespecialidadmedico($f3)
{
$idusuario = is_null($f3->get('POST.idusuario')) ? 'T' : $f3->get('POST.idusuario');
$llave = is_null($f3->get('POST.llave')) ? 'T' : $f3->get('POST.llave');
if ($this->M_Usuariologueado->ValidaSession($idusuario, $llave,'selespecialidadmedico',$f3)) {
...
$Con = $oDav_Ctrol->fnDevuelveConsulta('cli_visespecialidadmedico' , $pCampo0  , $pValor0  , $pCampo1  , $pValor1  , $pCampo2  , $pValor2  , $pCampo3  , $pValor3  , $pCampo4  , $pValor4  , $pCampo5  , $pValor5  , $pCampo6  , $pValor6  , $pCampo7  , $pValor7 );
$sql = $Con;
try {
...
public function addespecialidadmedico($f3)
{
$idusuario = is_null($f3->get('POST.idusuario')) ? 'T' : $f3->get('POST.idusuario');
$llave = is_null($f3->get('POST.llave')) ? 'T' : $f3->get('POST.llave');
if ($this->M_Usuariologueado->ValidaSession($idusuario, $llave,'addespecialidadmedico',$f3)) {
$Tipo = 'C';
$idespecialidadmedico = is_null($f3->get('POST.pidespecialidadmedico')) ? 'T' : $f3->get('POST.pidespecialidadmedico');
...
$sql = "CALL cli_pagespecialidadmedico('" . $Tipo . "','". $idespecialidadmedico . "','". $idmedico . "','". $idespecialidad . "','". $idusuario. "'); "; 
try {
$resulto = $f3->get('DB')->exec($sql);
$items = array();
$msg = '200';
...
public function getespecialidadmedico($f3)
{
$idusuario = is_null($f3->get('POST.idusuario')) ? 'T' : $f3->get('POST.idusuario');
$llave = is_null($f3->get('POST.llave')) ? 'T' : $f3->get('POST.llave');
if ($this->M_Usuariologueado->ValidaSession($idusuario, $llave,'getespecialidadmedico',$f3)) {
$Tipo = 'R';
$idespecialidadmedico = is_null($f3->get('POST.pidespecialidadmedico')) ? 'T' : $f3->get('POST.pidespecialidadmedico');
$idmedico = is_null($f3->get('POST.pidmedico')) ? 'T' : $f3->get('POST.pidmedico');
$idespecialidad = is_null($f3->get('POST.pidespecialidad')) ? 'T' : $f3->get('POST.pidespecialidad');
...
public function updespecialidadmedico($f3)
{
$idusuario = is_null($f3->get('POST.idusuario')) ? 'T' : $f3->get('POST.idusuario');
$llave = is_null($f3->get('POST.llave')) ? 'T' : $f3->get('POST.llave');
if ($this->M_Usuariologueado->ValidaSession($idusuario, $llave,'updespecialidadmedico',$f3)) {
$Tipo = 'U';
$idespecialidadmedico = is_null($f3->get('POST.pidespecialidadmedico')) ? 'T' : $f3->get('POST.pidespecialidadmedico');
$idmedico = is_null($f3->get('POST.pidmedico')) ? 'T' : $f3->get('POST.pidmedico');
$idespecialidad = is_null($f3->get('POST.pidespecialidad')) ? 'T' : $f3->get('POST.pidespecialidad');
...
public function papespecialidadmedico($f3)
{
$idusuario = is_null($f3->get('POST.idusuario')) ? 'T' : $f3->get('POST.idusuario');
$llave = is_null($f3->get('POST.llave')) ? 'T' : $f3->get('POST.llave');
if ($this->M_Usuariologueado->ValidaSession($idusuario, $llave,'papespecialidadmedico',$f3)) {
...
$idespecialidad = is_null($f3->get('POST.pidespecialidad')) ? 'T' : $f3->get('POST.pidespecialidad');
$idusuario = is_null($f3->get('POST.pidusuario')) ? 'T' : $f3->get('POST.pidusuario');
$sql = "CALL " . $procedure . "('" . $Tipo . "','". $idespecialidadmedico . "','". $idmedico . "','". $idespecialidad . "','". $idusuario. "'); "; 
try {
$resulto = $f3->get('DB')->exec($sql);
$items = array();
$msg = '200';
