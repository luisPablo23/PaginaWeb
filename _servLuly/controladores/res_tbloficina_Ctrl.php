<?php
//gen 25/2/2024 22:21:59 dst
class res_tbloficina_Ctrl
{
...
if ($this->M_Usuariologueado->ValidaSession($idusuario, $llave,'seloficina',$f3)) {
...
$Con = $oDav_Ctrol->fnDevuelveConsulta('res_visoficina' , $pCampo0  , $pValor0  , $pCampo1  , $pValor1  , $pCampo2  , $pValor2  , $pCampo3  , $pValor3  , $pCampo4  , $pValor4  , $pCampo5  , $pValor5  , $pCampo6  , $pValor6  , $pCampo7  , $pValor7 );
$sql = $Con;
try {
...
$idusuario = is_null($f3->get('POST.idusuario')) ? 'T' : $f3->get('POST.idusuario');
$llave = is_null($f3->get('POST.llave')) ? 'T' : $f3->get('POST.llave');
if ($this->M_Usuariologueado->ValidaSession($idusuario, $llave,'addoficina',$f3)) {
$Tipo = 'C';
...
$ubicacion = is_null($f3->get('POST.pubicacion')) ? 'T' : $f3->get('POST.pubicacion');
$sql = "CALL res_pagoficina('" . $Tipo . "','". $idoficina . "','". $nombreoficina . "','". $iddepartamento . "','". $direccion . "','". $ubicacion. "'); "; 
try {
$resulto = $f3->get('DB')->exec($sql);
$items = array();
$msg = '200';
...
$idusuario = is_null($f3->get('POST.idusuario')) ? 'T' : $f3->get('POST.idusuario');
$llave = is_null($f3->get('POST.llave')) ? 'T' : $f3->get('POST.llave');
if ($this->M_Usuariologueado->ValidaSession($idusuario, $llave,'getoficina',$f3)) {
$Tipo = 'R';
$idoficina = is_null($f3->get('POST.pidoficina')) ? 'T' : $f3->get('POST.pidoficina');
$nombreoficina = is_null($f3->get('POST.pnombreoficina')) ? 'T' : $f3->get('POST.pnombreoficina');
$iddepartamento = is_null($f3->get('POST.piddepartamento')) ? 'T' : $f3->get('POST.piddepartamento');
...
$idusuario = is_null($f3->get('POST.idusuario')) ? 'T' : $f3->get('POST.idusuario');
$llave = is_null($f3->get('POST.llave')) ? 'T' : $f3->get('POST.llave');
if ($this->M_Usuariologueado->ValidaSession($idusuario, $llave,'updoficina',$f3)) {
$Tipo = 'U';
$idoficina = is_null($f3->get('POST.pidoficina')) ? 'T' : $f3->get('POST.pidoficina');
$nombreoficina = is_null($f3->get('POST.pnombreoficina')) ? 'T' : $f3->get('POST.pnombreoficina');
$iddepartamento = is_null($f3->get('POST.piddepartamento')) ? 'T' : $f3->get('POST.piddepartamento');
...
$idusuario = is_null($f3->get('POST.idusuario')) ? 'T' : $f3->get('POST.idusuario');
$llave = is_null($f3->get('POST.llave')) ? 'T' : $f3->get('POST.llave');
if ($this->M_Usuariologueado->ValidaSession($idusuario, $llave,'papoficina',$f3)) {
...
$direccion = is_null($f3->get('POST.pdireccion')) ? 'T' : $f3->get('POST.pdireccion');
$ubicacion = is_null($f3->get('POST.pubicacion')) ? 'T' : $f3->get('POST.pubicacion');
$sql = "CALL " . $procedure . "('" . $Tipo . "','". $idoficina . "','". $nombreoficina . "','". $iddepartamento . "','". $direccion . "','". $ubicacion. "'); "; 
try {
$resulto = $f3->get('DB')->exec($sql);
$items = array();
$msg = '200';
