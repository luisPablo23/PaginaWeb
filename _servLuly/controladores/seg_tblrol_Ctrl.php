...
if ($this->M_Usuariologueado->ValidaSession($idusuario, $llave,'selrol',$f3)) {
...
$nombrerol = is_null($f3->get('POST.pnombrerol')) ? 'T' : $f3->get('POST.pnombrerol');
$imagen = is_null($f3->get('POST.pimagen')) ? 'T' : $f3->get('POST.pimagen');
$idsistema = is_null($f3->get('POST.pidsistema')) ? 'T' : $f3->get('POST.pidsistema');
$idnivelacceso = is_null($f3->get('POST.pidnivelacceso')) ? 'T' : $f3->get('POST.pidnivelacceso');
$sql = "CALL seg_pagrol('" . $Tipo . "','". $idrol . "','". $nombrerol . "','". $imagen . "','". $idsistema . "','". $idnivelacceso. "'); "; 
try {
$resulto = $f3->get('DB')->exec($sql);
$items = array();
$msg = '200';
...
$idsistema = is_null($f3->get('POST.pidsistema')) ? 'T' : $f3->get('POST.pidsistema');
$idnivelacceso = is_null($f3->get('POST.pidnivelacceso')) ? 'T' : $f3->get('POST.pidnivelacceso');
$sql = "CALL " . $procedure . "('" . $Tipo . "','". $idrol . "','". $nombrerol . "','". $imagen . "','". $idsistema . "','". $idnivelacceso. "'); "; 
try {
$resulto = $f3->get('DB')->exec($sql);
$items = array();
$msg = '200';
