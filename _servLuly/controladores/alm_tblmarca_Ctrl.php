<?php
//gen 25/2/2024 22:21:39 dst
class alm_tblmarca_Ctrl
{
...
$Con = $oDav_Ctrol->fnDevuelveConsulta('alm_vismarca' , $pCampo0  , $pValor0  , $pCampo1  , $pValor1  , $pCampo2  , $pValor2  , $pCampo3  , $pValor3  , $pCampo4  , $pValor4  , $pCampo5  , $pValor5  , $pCampo6  , $pValor6  , $pCampo7  , $pValor7 );
$sql = $Con;
try {
...
public function addmarca($f3)
{
$idusuario = is_null($f3->get('POST.idusuario')) ? 'T' : $f3->get('POST.idusuario');
$llave = is_null($f3->get('POST.llave')) ? 'T' : $f3->get('POST.llave');
if ($this->M_Usuariologueado->ValidaSession($idusuario, $llave,'addmarca',$f3)) {
$Tipo = 'C';
$idmarca = is_null($f3->get('POST.pidmarca')) ? 'T' : $f3->get('POST.pidmarca');
$nombremarca = is_null($f3->get('POST.pnombremarca')) ? 'T' : $f3->get('POST.pnombremarca');
$sql = "CALL alm_pagmarca('" . $Tipo . "','". $idmarca . "','". $nombremarca. "'); "; 
try {
$resulto = $f3->get('DB')->exec($sql);
$items = array();
$msg = '200';
...
public function getmarca($f3)
{
$idusuario = is_null($f3->get('POST.idusuario')) ? 'T' : $f3->get('POST.idusuario');
$llave = is_null($f3->get('POST.llave')) ? 'T' : $f3->get('POST.llave');
if ($this->M_Usuariologueado->ValidaSession($idusuario, $llave,'getmarca',$f3)) {
$Tipo = 'R';
$idmarca = is_null($f3->get('POST.pidmarca')) ? 'T' : $f3->get('POST.pidmarca');
$nombremarca = is_null($f3->get('POST.pnombremarca')) ? 'T' : $f3->get('POST.pnombremarca');
$sql = "CALL alm_pagmarca('" . $Tipo . "','". $idmarca . "','". $nombremarca. "'); "; 
...
public function updmarca($f3)
{
$idusuario = is_null($f3->get('POST.idusuario')) ? 'T' : $f3->get('POST.idusuario');
$llave = is_null($f3->get('POST.llave')) ? 'T' : $f3->get('POST.llave');
if ($this->M_Usuariologueado->ValidaSession($idusuario, $llave,'updmarca',$f3)) {
$Tipo = 'U';
$idmarca = is_null($f3->get('POST.pidmarca')) ? 'T' : $f3->get('POST.pidmarca');
$nombremarca = is_null($f3->get('POST.pnombremarca')) ? 'T' : $f3->get('POST.pnombremarca');
$sql = "CALL alm_pagmarca('" . $Tipo . "','". $idmarca . "','". $nombremarca. "'); "; 
...
public function papmarca($f3)
{
$idusuario = is_null($f3->get('POST.idusuario')) ? 'T' : $f3->get('POST.idusuario');
$llave = is_null($f3->get('POST.llave')) ? 'T' : $f3->get('POST.llave');
if ($this->M_Usuariologueado->ValidaSession($idusuario, $llave,'papmarca',$f3)) {
$Tipo = is_null($f3->get('POST.tipo')) ? 'T' : $f3->get('POST.tipo');
$procedure = is_null($f3->get('POST.procedure')) ? 'T' : $f3->get('POST.procedure');
$idmarca = is_null($f3->get('POST.pidmarca')) ? 'T' : $f3->get('POST.pidmarca');
$nombremarca = is_null($f3->get('POST.pnombremarca')) ? 'T' : $f3->get('POST.pnombremarca');
$sql = "CALL " . $procedure . "('" . $Tipo . "','". $idmarca . "','". $nombremarca. "'); "; 
try {
$resulto = $f3->get('DB')->exec($sql);
$items = array();
$msg = '200';
