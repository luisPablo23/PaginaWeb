<?php
//gen 25/2/2024 22:22:03 dst
class res_tbltramitegrupo_Ctrl
{
...
$Con = $oDav_Ctrol->fnDevuelveConsulta('res_vistramitegrupo' , $pCampo0  , $pValor0  , $pCampo1  , $pValor1  , $pCampo2  , $pValor2  , $pCampo3  , $pValor3  , $pCampo4  , $pValor4  , $pCampo5  , $pValor5  , $pCampo6  , $pValor6  , $pCampo7  , $pValor7 );
$sql = $Con;
try {
...
public function addtramitegrupo($f3)
{
$idusuario = is_null($f3->get('POST.idusuario')) ? 'T' : $f3->get('POST.idusuario');
$llave = is_null($f3->get('POST.llave')) ? 'T' : $f3->get('POST.llave');
if ($this->M_Usuariologueado->ValidaSession($idusuario, $llave,'addtramitegrupo',$f3)) {
$Tipo = 'C';
...
$nombretramitegrupo = is_null($f3->get('POST.pnombretramitegrupo')) ? 'T' : $f3->get('POST.pnombretramitegrupo');
$titulo = is_null($f3->get('POST.ptitulo')) ? 'T' : $f3->get('POST.ptitulo');
$sql = "CALL res_pagtramitegrupo('" . $Tipo . "','". $idtramitegrupo . "','". $idoficina . "','". $nombretramitegrupo . "','". $titulo. "'); "; 
try {
$resulto = $f3->get('DB')->exec($sql);
$items = array();
$msg = '200';
...
public function gettramitegrupo($f3)
{
$idusuario = is_null($f3->get('POST.idusuario')) ? 'T' : $f3->get('POST.idusuario');
$llave = is_null($f3->get('POST.llave')) ? 'T' : $f3->get('POST.llave');
if ($this->M_Usuariologueado->ValidaSession($idusuario, $llave,'gettramitegrupo',$f3)) {
$Tipo = 'R';
$idtramitegrupo = is_null($f3->get('POST.pidtramitegrupo')) ? 'T' : $f3->get('POST.pidtramitegrupo');
$idoficina = is_null($f3->get('POST.pidoficina')) ? 'T' : $f3->get('POST.pidoficina');
$nombretramitegrupo = is_null($f3->get('POST.pnombretramitegrupo')) ? 'T' : $f3->get('POST.pnombretramitegrupo');
...
public function updtramitegrupo($f3)
{
$idusuario = is_null($f3->get('POST.idusuario')) ? 'T' : $f3->get('POST.idusuario');
$llave = is_null($f3->get('POST.llave')) ? 'T' : $f3->get('POST.llave');
if ($this->M_Usuariologueado->ValidaSession($idusuario, $llave,'updtramitegrupo',$f3)) {
$Tipo = 'U';
$idtramitegrupo = is_null($f3->get('POST.pidtramitegrupo')) ? 'T' : $f3->get('POST.pidtramitegrupo');
$idoficina = is_null($f3->get('POST.pidoficina')) ? 'T' : $f3->get('POST.pidoficina');
$nombretramitegrupo = is_null($f3->get('POST.pnombretramitegrupo')) ? 'T' : $f3->get('POST.pnombretramitegrupo');
...
public function paptramitegrupo($f3)
{
$idusuario = is_null($f3->get('POST.idusuario')) ? 'T' : $f3->get('POST.idusuario');
$llave = is_null($f3->get('POST.llave')) ? 'T' : $f3->get('POST.llave');
if ($this->M_Usuariologueado->ValidaSession($idusuario, $llave,'paptramitegrupo',$f3)) {
...
$nombretramitegrupo = is_null($f3->get('POST.pnombretramitegrupo')) ? 'T' : $f3->get('POST.pnombretramitegrupo');
$titulo = is_null($f3->get('POST.ptitulo')) ? 'T' : $f3->get('POST.ptitulo');
$sql = "CALL " . $procedure . "('" . $Tipo . "','". $idtramitegrupo . "','". $idoficina . "','". $nombretramitegrupo . "','". $titulo. "'); "; 
try {
$resulto = $f3->get('DB')->exec($sql);
$items = array();
$msg = '200';
