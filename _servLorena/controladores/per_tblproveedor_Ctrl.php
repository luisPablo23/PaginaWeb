...
$Con = $oDav_Ctrol->fnDevuelveConsulta('per_visproveedor' , $pCampo0  , $pValor0  , $pCampo1  , $pValor1  , $pCampo2  , $pValor2  , $pCampo3  , $pValor3  , $pCampo4  , $pValor4  , $pCampo5  , $pValor5  , $pCampo6  , $pValor6  , $pCampo7  , $pValor7 );
$sql = $Con;
try {
...
public function addproveedor($f3)
{
$idusuario = is_null($f3->get('POST.idusuario')) ? 'T' : $f3->get('POST.idusuario');
$llave = is_null($f3->get('POST.llave')) ? 'T' : $f3->get('POST.llave');
if ($this->M_Usuariologueado->ValidaSession($idusuario, $llave,'addproveedor',$f3)) {
$Tipo = 'C';
...
$idtipoproveedor = is_null($f3->get('POST.pidtipoproveedor')) ? 'T' : $f3->get('POST.pidtipoproveedor');
$sql = "CALL per_pagproveedor('" . $Tipo . "','". $idproveedor . "','". $idpersona . "','". $idtipoproveedor. "'); "; 
try {
$resulto = $f3->get('DB')->exec($sql);
$items = array();
$msg = '200';
...
public function getproveedor($f3)
{
$idusuario = is_null($f3->get('POST.idusuario')) ? 'T' : $f3->get('POST.idusuario');
$llave = is_null($f3->get('POST.llave')) ? 'T' : $f3->get('POST.llave');
if ($this->M_Usuariologueado->ValidaSession($idusuario, $llave,'getproveedor',$f3)) {
$Tipo = 'R';
$idproveedor = is_null($f3->get('POST.pidproveedor')) ? 'T' : $f3->get('POST.pidproveedor');
$idpersona = is_null($f3->get('POST.pidpersona')) ? 'T' : $f3->get('POST.pidpersona');
$idtipoproveedor = is_null($f3->get('POST.pidtipoproveedor')) ? 'T' : $f3->get('POST.pidtipoproveedor');
...
public function updproveedor($f3)
{
$idusuario = is_null($f3->get('POST.idusuario')) ? 'T' : $f3->get('POST.idusuario');
$llave = is_null($f3->get('POST.llave')) ? 'T' : $f3->get('POST.llave');
if ($this->M_Usuariologueado->ValidaSession($idusuario, $llave,'updproveedor',$f3)) {
$Tipo = 'U';
$idproveedor = is_null($f3->get('POST.pidproveedor')) ? 'T' : $f3->get('POST.pidproveedor');
$idpersona = is_null($f3->get('POST.pidpersona')) ? 'T' : $f3->get('POST.pidpersona');
$idtipoproveedor = is_null($f3->get('POST.pidtipoproveedor')) ? 'T' : $f3->get('POST.pidtipoproveedor');
...
public function papproveedor($f3)
{
$idusuario = is_null($f3->get('POST.idusuario')) ? 'T' : $f3->get('POST.idusuario');
$llave = is_null($f3->get('POST.llave')) ? 'T' : $f3->get('POST.llave');
if ($this->M_Usuariologueado->ValidaSession($idusuario, $llave,'papproveedor',$f3)) {
$Tipo = is_null($f3->get('POST.tipo')) ? 'T' : $f3->get('POST.tipo');
$procedure = is_null($f3->get('POST.procedure')) ? 'T' : $f3->get('POST.procedure');
$idproveedor = is_null($f3->get('POST.pidproveedor')) ? 'T' : $f3->get('POST.pidproveedor');
$idpersona = is_null($f3->get('POST.pidpersona')) ? 'T' : $f3->get('POST.pidpersona');
$idtipoproveedor = is_null($f3->get('POST.pidtipoproveedor')) ? 'T' : $f3->get('POST.pidtipoproveedor');
$sql = "CALL " . $procedure . "('" . $Tipo . "','". $idproveedor . "','". $idpersona . "','". $idtipoproveedor. "'); "; 
try {
$resulto = $f3->get('DB')->exec($sql);
$items = array();
$msg = '200';
