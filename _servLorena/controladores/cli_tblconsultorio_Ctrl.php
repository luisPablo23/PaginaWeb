<?php
//gen 25/2/2024 22:21:50 dst
class cli_tblconsultorio_Ctrl
{
...
$Con = $oDav_Ctrol->fnDevuelveConsulta('cli_visconsultorio' , $pCampo0  , $pValor0  , $pCampo1  , $pValor1  , $pCampo2  , $pValor2  , $pCampo3  , $pValor3  , $pCampo4  , $pValor4  , $pCampo5  , $pValor5  , $pCampo6  , $pValor6  , $pCampo7  , $pValor7 );
$sql = $Con;
try {
...
public function addconsultorio($f3)
{
$idusuario = is_null($f3->get('POST.idusuario')) ? 'T' : $f3->get('POST.idusuario');
$llave = is_null($f3->get('POST.llave')) ? 'T' : $f3->get('POST.llave');
if ($this->M_Usuariologueado->ValidaSession($idusuario, $llave,'addconsultorio',$f3)) {
$Tipo = 'C';
$idconsultorio = is_null($f3->get('POST.pidconsultorio')) ? 'T' : $f3->get('POST.pidconsultorio');
$nombreconsultorio = is_null($f3->get('POST.pnombreconsultorio')) ? 'T' : $f3->get('POST.pnombreconsultorio');
$numeroconsultorio = is_null($f3->get('POST.pnumeroconsultorio')) ? 'T' : $f3->get('POST.pnumeroconsultorio');
$detalle = is_null($f3->get('POST.pdetalle')) ? 'T' : $f3->get('POST.pdetalle');
$horainiciorefrigerio = is_null($f3->get('POST.phorainiciorefrigerio')) ? 'T' : $f3->get('POST.phorainiciorefrigerio');
$horafinrefrigerio = is_null($f3->get('POST.phorafinrefrigerio')) ? 'T' : $f3->get('POST.phorafinrefrigerio');
$sql = "CALL cli_pagconsultorio('" . $Tipo . "','". $idconsultorio . "','". $nombreconsultorio . "','". $numeroconsultorio . "','". $detalle . "','". $horainiciorefrigerio . "','". $horafinrefrigerio. "'); "; 
try {
$resulto = $f3->get('DB')->exec($sql);
$items = array();
$msg = '200';
...
public function getconsultorio($f3)
{
$idusuario = is_null($f3->get('POST.idusuario')) ? 'T' : $f3->get('POST.idusuario');
$llave = is_null($f3->get('POST.llave')) ? 'T' : $f3->get('POST.llave');
if ($this->M_Usuariologueado->ValidaSession($idusuario, $llave,'getconsultorio',$f3)) {
$Tipo = 'R';
$idconsultorio = is_null($f3->get('POST.pidconsultorio')) ? 'T' : $f3->get('POST.pidconsultorio');
$nombreconsultorio = is_null($f3->get('POST.pnombreconsultorio')) ? 'T' : $f3->get('POST.pnombreconsultorio');
$numeroconsultorio = is_null($f3->get('POST.pnumeroconsultorio')) ? 'T' : $f3->get('POST.pnumeroconsultorio');
...
public function updconsultorio($f3)
{
$idusuario = is_null($f3->get('POST.idusuario')) ? 'T' : $f3->get('POST.idusuario');
$llave = is_null($f3->get('POST.llave')) ? 'T' : $f3->get('POST.llave');
if ($this->M_Usuariologueado->ValidaSession($idusuario, $llave,'updconsultorio',$f3)) {
$Tipo = 'U';
$idconsultorio = is_null($f3->get('POST.pidconsultorio')) ? 'T' : $f3->get('POST.pidconsultorio');
$nombreconsultorio = is_null($f3->get('POST.pnombreconsultorio')) ? 'T' : $f3->get('POST.pnombreconsultorio');
$numeroconsultorio = is_null($f3->get('POST.pnumeroconsultorio')) ? 'T' : $f3->get('POST.pnumeroconsultorio');
...
public function papconsultorio($f3)
{
$idusuario = is_null($f3->get('POST.idusuario')) ? 'T' : $f3->get('POST.idusuario');
$llave = is_null($f3->get('POST.llave')) ? 'T' : $f3->get('POST.llave');
if ($this->M_Usuariologueado->ValidaSession($idusuario, $llave,'papconsultorio',$f3)) {
...
$horainiciorefrigerio = is_null($f3->get('POST.phorainiciorefrigerio')) ? 'T' : $f3->get('POST.phorainiciorefrigerio');
$horafinrefrigerio = is_null($f3->get('POST.phorafinrefrigerio')) ? 'T' : $f3->get('POST.phorafinrefrigerio');
$sql = "CALL " . $procedure . "('" . $Tipo . "','". $idconsultorio . "','". $nombreconsultorio . "','". $numeroconsultorio . "','". $detalle . "','". $horainiciorefrigerio . "','". $horafinrefrigerio. "'); "; 
try {
$resulto = $f3->get('DB')->exec($sql);
$items = array();
$msg = '200';
