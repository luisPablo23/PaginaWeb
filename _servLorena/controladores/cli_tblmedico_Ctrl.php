...
$Con = $oDav_Ctrol->fnDevuelveConsulta('cli_vismedico' , $pCampo0  , $pValor0  , $pCampo1  , $pValor1  , $pCampo2  , $pValor2  , $pCampo3  , $pValor3  , $pCampo4  , $pValor4  , $pCampo5  , $pValor5  , $pCampo6  , $pValor6  , $pCampo7  , $pValor7 );
$sql = $Con;
try {
...
public function addmedico($f3)
{
$idusuario = is_null($f3->get('POST.idusuario')) ? 'T' : $f3->get('POST.idusuario');
$llave = is_null($f3->get('POST.llave')) ? 'T' : $f3->get('POST.llave');
if ($this->M_Usuariologueado->ValidaSession($idusuario, $llave,'addmedico',$f3)) {
$Tipo = 'C';
$idmedico = is_null($f3->get('POST.pidmedico')) ? 'T' : $f3->get('POST.pidmedico');
$idusuario = is_null($f3->get('POST.pidusuario')) ? 'T' : $f3->get('POST.pidusuario');
$matricula = is_null($f3->get('POST.pmatricula')) ? 'T' : $f3->get('POST.pmatricula');
$sql = "CALL cli_pagmedico('" . $Tipo . "','". $idmedico . "','". $idusuario . "','". $matricula. "'); "; 
try {
$resulto = $f3->get('DB')->exec($sql);
$items = array();
$msg = '200';
...
public function getmedico($f3)
{
$idusuario = is_null($f3->get('POST.idusuario')) ? 'T' : $f3->get('POST.idusuario');
$llave = is_null($f3->get('POST.llave')) ? 'T' : $f3->get('POST.llave');
if ($this->M_Usuariologueado->ValidaSession($idusuario, $llave,'getmedico',$f3)) {
$Tipo = 'R';
$idmedico = is_null($f3->get('POST.pidmedico')) ? 'T' : $f3->get('POST.pidmedico');
$idusuario = is_null($f3->get('POST.pidusuario')) ? 'T' : $f3->get('POST.pidusuario');
$matricula = is_null($f3->get('POST.pmatricula')) ? 'T' : $f3->get('POST.pmatricula');
...
public function updmedico($f3)
{
$idusuario = is_null($f3->get('POST.idusuario')) ? 'T' : $f3->get('POST.idusuario');
$llave = is_null($f3->get('POST.llave')) ? 'T' : $f3->get('POST.llave');
if ($this->M_Usuariologueado->ValidaSession($idusuario, $llave,'updmedico',$f3)) {
$Tipo = 'U';
$idmedico = is_null($f3->get('POST.pidmedico')) ? 'T' : $f3->get('POST.pidmedico');
$idusuario = is_null($f3->get('POST.pidusuario')) ? 'T' : $f3->get('POST.pidusuario');
$matricula = is_null($f3->get('POST.pmatricula')) ? 'T' : $f3->get('POST.pmatricula');
...
public function papmedico($f3)
{
$idusuario = is_null($f3->get('POST.idusuario')) ? 'T' : $f3->get('POST.idusuario');
$llave = is_null($f3->get('POST.llave')) ? 'T' : $f3->get('POST.llave');
if ($this->M_Usuariologueado->ValidaSession($idusuario, $llave,'papmedico',$f3)) {
$Tipo = is_null($f3->get('POST.tipo')) ? 'T' : $f3->get('POST.tipo');
$procedure = is_null($f3->get('POST.procedure')) ? 'T' : $f3->get('POST.procedure');
$idmedico = is_null($f3->get('POST.pidmedico')) ? 'T' : $f3->get('POST.pidmedico');
$idusuario = is_null($f3->get('POST.pidusuario')) ? 'T' : $f3->get('POST.pidusuario');
$matricula = is_null($f3->get('POST.pmatricula')) ? 'T' : $f3->get('POST.pmatricula');
$sql = "CALL " . $procedure . "('" . $Tipo . "','". $idmedico . "','". $idusuario . "','". $matricula. "'); "; 
try {
$resulto = $f3->get('DB')->exec($sql);
$items = array();
$msg = '200';
